                  ...
                  <form action="/{{$data->id}}/edit" method="post">
                    ...
                    <div class="form-group row mb-4 hide-sign">
                        ...
                        <select name="room_no" id="room_no" class="form-select dropdown_item_select" onchange='saveValue(this);' required>
                            <option value="{{ $data->room_no }}" selected>{{ $data->room_no }}</option>
                    ...
                    <div class="form-group row mb-4 hide-sign">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" name="remark" id="remark" class="form-control" value="{{ $data->remark }}" onkeyup='saveValue(this);'>
                      </div>
                    </div>
                    <div class="form-group row mb-4 hide-sign">
...
<script type="text/javascript">
    ...
    if(sessionStorage.length != 0){
      ...
      saveValue(document.getElementById("remark"));
    }
